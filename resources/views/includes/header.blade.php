    ...
    <div class="header__topbar bg__primary">
        <div class="container">
            <div class="header__topbar--inner text-center">
                <p class="header__info--text text-white">CONTACT US DIRECTLY ON : +6281210211661</p>
            </div>
        </div>
    </div>
    <div class="main__header position__relative header__sticky">
        <div class="container">
            <div class="main__header--inner d-flex align-items-center">
                ...
                <div class="main__logo" style="width:10%">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="#">
                        <img class="main__logo--img" src="{{ asset('images/logo/nav-logo.webp') }}" alt="logo-img">
                    </a></h1>
                </div>
                <div class="header__menu d-none d-lg-block" style="margin-left:auto">
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{ asset('images/product/small-product/product1.webp') }}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{ asset('images/product/small-product/product2.webp') }}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
